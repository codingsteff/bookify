...
internal sealed class CustomClaimsTransformation : IClaimsTransformation
{
    ...
    {
        // ClaimTypes.Role is expected by the authorized attribute
        // JwtRegisteredClaimNames.Sub for resource based authorization (ASP.NET Corre transform the incoming sub claim to the name identifier claim)
