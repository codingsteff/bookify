...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20250731061533_Users_Email_ComplexProp")]
    partial class Users_Email_ComplexProp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bookify.Domain.Users.User", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Email", "Bookify.Domain.Users.User.Email#Email", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Common.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
